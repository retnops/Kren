...
public class Chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sms_activitychat);
        ...
        send_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(text.length()>0) {
                    ...
                    if(FunctionSms.sendSMS(address, tmp_msg))
                    {
                        new_message.setText("");
                        ...
                        customList.add(FunctionSms.mappingInbox(null, null, null, null, tmp_msg, "2", null, "Sending..."));
    ...
    class LoadSms extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (c.moveToFirst()) {
                    for (int i = 0; i < c.getCount(); i++) {
                        ...
                        tmpList.add(FunctionSms.mappingInbox(_id, thread_id, name, phone, msg, type, timestamp, FunctionSms.converToTime(timestamp)));
                        c.moveToNext();
                    }
                }
                c.close();
            ...
            Collections.sort(tmpList, new MapSmscomparator(FunctionSms.KEY_TIMESTAMP, "asc"));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(activity).inflate(
                    R.layout.sms_chatitem, parent, false);
        ...
        try {
            ...
            if(song.get(FunctionSms.KEY_TYPE).contentEquals("1"))
            {
                holder.lblMsgFrom.setText(song.get(FunctionSms.KEY_NAME));
                holder.txtMsgFrom.setText(song.get(FunctionSms.KEY_MSG));
                holder.timeMsgFrom.setText(song.get(FunctionSms.KEY_TIME));
                holder.msgFrom.setVisibility(View.VISIBLE);
                holder.msgYou.setVisibility(View.GONE);
            }else{
                holder.lblMsgYou.setText("You");
                holder.txtMsgYou.setText(song.get(FunctionSms.KEY_MSG));
                holder.timeMsgYou.setText(song.get(FunctionSms.KEY_TIME));
